...
const NoteCard = ({ _id, category, title, body, views, comments }: CardProps) => {
  ...
  return (
    <div
      key={_id}
      className="flex flex-col bg-white dark:bg-gray-800 dark:text-gray-300
 shadow-lg rounded-lg p-4 mx-2 
      my-2 md:w-96">
      <div className="hidden md:flex md:justify-between mb-2">
        ...
        <div
          className="bg-blue-500 dark:bg-blue-950 text-white dark:text-gray-300 px-2 py-1 rounded-full cursor-pointer"
      ...
      <div className="flex justify-between items-center text-gray-500">
        ...
        <div className="flex items-center">
          <TfiThemifyFaviconAlt
            className="mr-1 text-indigo-400 dark:text-gray-300"
          />
          <span>{comments}</span>
        </div>
      </div>
